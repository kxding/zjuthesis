...
\documentclass[
    ...
    StudentName     = 丁凯欣,
    StudentID       = 3210104740,
    AdvisorName     = 陈建海,
    Grade           = 2021,            % only the year, no '级'
    Major           = 计算机科学与技术,
    Department      = 计算机科学与技术学院,
    SubmitDate      = 2025年5月14日,
    MajorFormat     = cs,
    ...
    % Title
    Title           = 基于DiT模型参考图可控视频一致性生成,
    TitleEng        = {{DiT-based Ref-images Video Consistency Generation}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{基于DiT模型参考图}{可控视频一致性生成}
